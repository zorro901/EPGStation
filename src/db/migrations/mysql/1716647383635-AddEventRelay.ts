...
export class AddEventRelay1716647383635 implements MigrationInterface {
    name = 'AddEventRelay1716647383635';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`reserve\` ADD \`isEventRelay\` tinyint NOT NULL DEFAULT 0`);
        ...
        await queryRunner.query(
            `ALTER TABLE \`recorded_tags_recorded_tag\` ADD CONSTRAINT \`FK_4bf93992f2a6020b74bbf80cf4c\` FOREIGN KEY (\`recordedId\`) REFERENCES \`recorded\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
        );
        await queryRunner.query(
            `ALTER TABLE \`recorded_tags_recorded_tag\` ADD CONSTRAINT \`FK_c5315b388628971c92d241be9c8\` FOREIGN KEY (\`recordedTagId\`) REFERENCES \`recorded_tag\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
        );
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`reserve\` DROP COLUMN \`isEventRelay\``);
        await queryRunner.query(
